...
int main(int argc, char *argv[]){
  ...
  if (configParameters->getHdiType() == "fpix") { LOG(logDEBUG) << "Initial Module Temperatue: " << Form("%3.1f", api->getTemp()) << " C"; }
  ...
  if (configParameters->getHdiType() == "fpix") { LOG(logDEBUG) << "Final Module Temperatue: " << Form("%3.1f", api->getTemp()) << " C"; }
