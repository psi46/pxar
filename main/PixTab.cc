...
PixTab::PixTab(PixGui *p, PixTest *test, string tabname) {
  ...
  fhFrame->AddFrame(fV1, new TGLayoutHints(kLHintsLeft | kLHintsExpandX | kLHintsExpandY, 2, 2, 2, 2)); // DP
  fV2 = new TGVerticalFrame(fhFrame);
  fhFrame->AddFrame(fV2, new TGLayoutHints(kLHintsRight | kLHintsExpandY, 2, 2, 2, 2)); // DP

  // -- fV1: create and add Embedded Canvas
  fEc1 = new TRootEmbeddedCanvas(Form("%s", tabname.c_str()), fV1, 700, 500); // DP
  fV1->AddFrame(fEc1, new TGLayoutHints(kLHintsTop | kLHintsLeft | kLHintsExpandX | kLHintsExpandY, 2, 2, 2, 2));
  ...
  hFrame->AddFrame(fbDoTest, new TGLayoutHints(kLHintsLeft | kLHintsTop, 2, 5, 2, 2)); // DP
  ...
  hFrame->AddFrame(bStop, new TGLayoutHints(kLHintsLeft | kLHintsTop, 2, 5, 2, 2)); // DP
  ...
  hFrame->AddFrame(bPrint, new TGLayoutHints(kLHintsLeft | kLHintsTop, 2, 5, 2, 2));
  ...
  hFrame->AddFrame(fbModMap, new TGLayoutHints(kLHintsLeft | kLHintsTop, 2, 5, 2, 2));
  ...
  hFrame->AddFrame(bClose, new TGLayoutHints(kLHintsRight | kLHintsTop, 2, 5, 2, 2));
