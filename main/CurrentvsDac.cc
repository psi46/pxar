...
ClassImp(CurrentvsDac)

// ----------------------------------------------------------------------
CurrentvsDac::CurrentvsDac( PixSetup *a, std::string name )
...
//----------------------------------------------------------
CurrentvsDac::CurrentvsDac() : PixTest()
{
  LOG(logINFO) << "CurrentvsDac ctor()";
}

// ----------------------------------------------------------------------
bool CurrentvsDac::setParameter( string parName, string sval )
{
  bool found(false);
...
// ----------------------------------------------------------------------
void CurrentvsDac::bookHist(string name) // general booking routine
{
  fDirectory->cd();
...
//----------------------------------------------------------
CurrentvsDac::~CurrentvsDac()
{
  //  LOG(logINFO) << "CurrentvsDac dtor";
...
// ----------------------------------------------------------------------
void CurrentvsDac::doTest()
{
  PixTest::update();

  LOG(logINFO) << "CurrentvsDac::doTest() DAC = " << fParDAC;
