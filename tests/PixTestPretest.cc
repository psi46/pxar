...
//------------------------------------------------------------------------------
statistics PixTestPretest::getEvents(int NEvents, int period, int buffer) {
...
// ----------------------------------------------------------------------
bool PixTestPretest::checkReadBackBits(uint16_t period) {
...
//------------------------------------------------------------------------------
uint8_t PixTestPretest::GetTBMSetting(string base, size_t tbmId) {
