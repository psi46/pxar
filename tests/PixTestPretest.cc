...
// ----------------------------------------------------------------------
void PixTestPretest::getVthrCompThr() {
...
// ----------------------------------------------------------------------
vector<int> PixTestPretest::xPixelAliveSingleSweep() { 
...
// ----------------------------------------------------------------------
pair<vector<TH2D*>,vector<TH2D*> > PixTestPretest::xEfficiencyMaps(string name, uint16_t ntrig, uint16_t FLAGS) {
...
// ----------------------------------------------------------------------
string PixTestPretest::getVthrCompString(vector<uint8_t>rocIds,vector<int> VthrComp ) {
