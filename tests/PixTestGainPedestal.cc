...
// ----------------------------------------------------------------------
string PixTestGainPedestal::toolTip(string what) {
  if (string::npos != what.find("measure")) return string("Measure puselheight for different VCAL settings ");
  if (string::npos != what.find("fit")) return string("fit all the measured PH vs VCAL settings ");
  if (string::npos != what.find("save")) return string("save the results to dedicated files ");
  return string("nada");
}
